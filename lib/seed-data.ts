...
export const SEED_REPORTS: Report[] = [
  {
    id: "r1",
    type: "lost",
    title: "Dompet kulit hitam berisi KTP",
    description: "Dompet kulit hitam merek Nature Republic, di dalamnya KTP atas nama Budi Santoso, kartu ATM BCA, dan uang tunai Rp200rb. Hilang saat naik KRL jurusan Bogor.",
    category_id: "c1",
  ...
  },
  {
    id: "r2",
    type: "found",
    title: "Kunci motor ring satpam",
    description: "Ditemukan sepasang kunci motor dengan gantungan ring satpam warna kuning di lobby gedung. Silakan hubungi via chat untuk konfirmasi ciri.",
    category_id: "c2",
    category_name: "Kunci",
    color: "Kuning",
    image_url: "https://images.unsplash.com/photo-1587876931567-0642fc1981d4?w=600&q=80",
    location: "Lobby Graha Pena, Bandung",
    reward: null,
    province: "Jawa Barat",
    city: "Bandung",
    reported_at: daysAgo(1),
    lost_found_date: daysAgo(1),
    status: "published",
    owner_id: "u2",
    author: profiles.u2,
    rejection_reason: null,
  ...
  },
  {
    id: "r3",
    type: "lost",
    title: "iPhone 13 warna midnight",
    description: "iPhone 13 warna midnight, layar agak retak di pojok kanan, casing bening. Hilang di area kampus.",
    category_id: "c3",
  ...
  },
  {
    id: "r4",
    type: "found",
    title: "Kartu mahasiswa & ijazah SMA",
    description: "Ditemukan berkas berisi kartu mahasiswa dan ijazah SMA dalam map warna biru di taman kota.",
    category_id: "c4",
    category_name: "Dokumen",
    color: "Biru",
    image_url: "https://images.unsplash.com/photo-1606851094291-6efae152bb87?w=600&q=80",
    location: "Taman Kota, Yogyakarta",
    reward: null,
    province: "DI Yogyakarta",
    city: "Yogyakarta",
    reported_at: daysAgo(3),
    lost_found_date: daysAgo(3),
    status: "published",
    owner_id: "u4",
    author: profiles.u4,
    rejection_reason: null,
  ...
  },
  {
    id: "r5",
    type: "lost",
    title: "Kucing persia cream hilang",
    description: "Kucing persia warna cream, jantan, memakai kalung merah. Hilang dari rumah sekitar sore hari.",
    category_id: "c6",
    category_name: "Hewan Peliharaan",
    color: "Putih",
    image_url: "https://images.unsplash.com/photo-1514888286974-6c03e2ca1dba?w=600&q=80",
    location: "Komplek BSD, Tangerang",
    reward: "Rp500.000",
    province: "Banten",
    city: "Jakarta",
    reported_at: daysAgo(5),
    lost_found_date: daysAgo(5),
    status: "published",
    owner_id: "u1",
    author: profiles.u1,
    rejection_reason: null,
  ...
  },
  {
    id: "r6",
    type: "found",
    title: "Jam tangan kasual hitam",
    description: "Jam tangan warna hitam tali kulit, ditemukan di dalam angkot rute 02.",
    category_id: "c8",
    category_name: "Perhiasan",
    color: "Hitam",
    image_url: "https://images.unsplash.com/photo-1524592094714-0f0654e20314?w=600&q=80",
    location: "Halte Dago, Bandung",
    reward: null,
    province: "Jawa Barat",
    city: "Bandung",
    reported_at: daysAgo(2),
  ...
  },
  {
    id: "r7",
    type: "lost",
    title: "Tas ransel merah polytechnic",
    description: "Tas ransel merah dengan banyak sticker, isi buku dan laptop. Hilang di atas kereta.",
    category_id: "c7",
    category_name: "Tas",
    color: "Merah",
  ...
  },
  {
    id: "r8",
    type: "found",
    title: "Sandal jepit biru",
    description: "Sepasang sandal jepit warna biru ditemukan di pantai.",
    category_id: "c9",
